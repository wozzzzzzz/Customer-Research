                ...
                <div style={containerStyle}>
                    ...
                    <div>
                        ...
                        <div style={buttonGroupStyle}>
                            {['지인추천', '인스타그램', '네이버검색', '블로그 포스트', '온라인커뮤니티', '기타'].map((range) => (
                                <button
                                    type="button"
                                    key={range}
                                    style={answers.NoticeRoute === range ? selectedButtonStyle : buttonStyle}
                                    onClick={() => handleChange('NoticeRoute', range)}>
                                    {range}
                                </button>
                            ))}
                        </div>

                        {answers.NoticeRoute === '기타' && (
                        <div >
                            <input
                                type="text"
                                value={otherText}
